...
![Full picture of proposed multi-region logging infrastructure]({{ site.data.config['assets'] }}multi-region logging architecture.png)
...
![Specific datacenter logging from application nodes to broker]({{ site.data.config['assets'] }}multi-region logging - web to broker.png)
